...
@section('botones')
    <a class="btn btn-primary" href="{{route('recetas.index')}}">Volver a Helados</a>
@endsection

@section('content')
   
    <h2 class="text-center mb-3"> Editar  Helado : {{$receta->nombre}}</h2>
    ...
    <div class=" mt-5">
        ...
        <form method="POST" action={{route("recetas.update",['receta'=>$receta->id])}} enctype="multipart/form-data" novalidate>
            ...
            <div class="form-group">
                ...
                id="nombre" placeholder="Nombre Helado" value="{{$receta->nombre}}"}>
                ...
                <div class="form-group">
                   ...
                   <option value={{$categoria->id}}  {{$receta->categoria_id==$categoria->id ? 'selected' : ''}}>{{$categoria->nombre}}</option>
                    ...
                    <div class="form-group mt-3 row justify-content-center" >
                        <input type="submit" class="btn btn-primary" value="Editar Helado">
                    <div>
