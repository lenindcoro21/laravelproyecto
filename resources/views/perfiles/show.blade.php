...
@section('content')
    ...
    <h2 class="text-center my-5"> Recetas credas por : {{$perfil->perfilUser->name}}</h2>
     <div class="container" >
        <div class="row mx-auto bg-white p-4">
            {{-- Verficar informacion de las recetas --}}
             @if(count($userRecetas)>0)
               ...
               @endforeach
            @else   
              <p class="text-center w-100">No existe  recetas aún ... </p>
            @endif
